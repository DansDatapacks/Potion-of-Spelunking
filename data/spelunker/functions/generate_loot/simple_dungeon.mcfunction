...
execute if score #RNG spelunker.temp matches 80..95 at @e[type=marker,tag=spelunker.raycast.ray,limit=1] run loot insert ~ ~ ~ loot spelunker:potion_of_spelunking
...
#reset
advancement revoke @s only spelunker:generate_loot/simple_dungeon