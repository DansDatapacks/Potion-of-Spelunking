...
execute unless entity @e[distance=..0.5,type=minecraft:shulker,tag=spelunker.spelunked_ore] run function spelunker:run_spelunker_effect/summon_spelunked_ore_marker
