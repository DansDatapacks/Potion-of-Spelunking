...
execute unless score @s spelunker.row matches 9.. at @s run function spelunker:run_spelunker_effect/run_spelunk_scan
...
execute unless score @s spelunker.layer matches 5.. at @s run function spelunker:run_spelunker_effect/run_spelunk_scan