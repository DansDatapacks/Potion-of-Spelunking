...
execute if block ~ ~ ~ minecraft:gilded_blackstone run team join spelunker.gold_ore @e[type=minecraft:shulker,tag=spelunker.spelunked_ore_init,limit=1,sort=nearest]
...
#execute unless score #heart_crystals load.status matches 1.. if block ~ ~ ~ minecraft:deepslate_emerald_ore run team join spelunker.emerald_ore @e[type=minecraft:shulker,tag=spelunker.spelunked_ore_init,limit=1,sort=nearest]
...
# #heart crystal ore
# execute if score #heart_crystals load.status matches 1.. if block ~ ~ ~ minecraft:deepslate_emerald_ore run team join spelunker.heartcrystal_ore @e[type=minecraft:shulker,tag=spelunker.spelunked_ore_init,limit=1,sort=nearest]
