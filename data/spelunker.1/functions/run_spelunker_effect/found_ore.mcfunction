...
execute unless entity @e[distance=..0.5,type=minecraft:shulker,tag=spelunker.spelunked_ore] run function spelunker.1:run_spelunker_effect/summon_spelunked_ore_marker
