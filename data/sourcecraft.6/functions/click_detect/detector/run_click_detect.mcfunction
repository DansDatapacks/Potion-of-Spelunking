...
# execute unless entity @e[type=minecraft:wandering_trader,tag=sourcecraft.click_detect.entity,tag=sourcecraft.click_detect.entity.found,limit=1] run function sourcecraft.6:click_detect/detector/init_click_detect
...
execute as @e[type=minecraft:wandering_trader,tag=sourcecraft.click_detect.entity,tag=sourcecraft.click_detect.entity.found,limit=1,sort=nearest] at @s run function sourcecraft.6:predictive_sync/run_sync
