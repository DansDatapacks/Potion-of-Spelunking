...
execute unless score @s spelunker.row matches 18.. at @s run function spelunker.2:run_spelunker_effect/run_spelunk_two_scan
...
execute unless score @s spelunker.layer matches 10.. at @s run function spelunker.2:run_spelunker_effect/run_spelunk_two_scan